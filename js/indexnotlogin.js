       ...
       if (n !== null) {
           ...
           xhr.onreadystatechange = function () {
               if (xhr.readyState == 4 && xhr.status == 200) {
                ...
                <a class="${arr[i].pic != "null" ? "col-3" : ''}" href="logintj.html?pid=${arr[i].pid}">
                <img src="${arr[i].pic}" style="${arr[i].pic != 'null' ? 'width:10rem' : ''}">
                </a>
                <div class="col-9">
                <div class="row mt-lg-2 ml-0" style="min-width:160px;">
                <a class="col-12" href="logintj.html?pid=${arr[i].pid}"><span class="font-size-1">${arr[i].title}</span></a>
                <div class="col-12 mt-3"><a class="mr-3" href="logintj.html?pid=${arr[i].pid}#source"><span><img src="${arr[i].Source_picture}" alt=""/>${arr[i].source}</span></a>
